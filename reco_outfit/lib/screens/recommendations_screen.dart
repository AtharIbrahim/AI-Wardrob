...
class _RecommendationsScreenState extends State<RecommendationsScreen> {
        ...
        child: Column(
          ...
          children: [
            ResponsiveSectionHeader(
              ...
              subtitle: 'Tell us what you\'re looking for today',
            ),
  ...
  Widget _buildGenerateButton(BuildContext context, WardrobeProvider provider) {
    return ResponsiveButton(
      text: provider.isLoading ? 'Creating magic...' : 'Generate Style Recommendations',
      icon: provider.isLoading ? null : Icons.auto_fix_high,
        ...
        child: Center(
          child: Padding(
            ...
            child: ResponsiveLoading(
              message: 'AI is analyzing your wardrobe and creating the perfect outfit combinations for you...',
